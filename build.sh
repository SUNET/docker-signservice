...
usage() {
    ...
    echo "   -i, --image            Name of image to create (default is cs-sigserver)"
...
ARTIFACT_NAME=cs-sigserver-consolidated
ARTIFACT_REPO_PATH=/com/aaasec/sigserv/${ARTIFACT_NAME}/
FILE_EXTENSION=war
...
#
# Build maven project to build the tomcat with applications and scripts
#
