...
The signservice applicatin is exposed in the deployed docker container under the service path `/cs-sigserver`. The web frontent will assign a service base URL to this resource location. This is named the **BASE_URL** in the configuration documentation below.
